...
async def scrape_copart(lot: str):
    ...
    async with async_playwright() as p:
        ...
        try:
            await page.goto(url, timeout=10000)  # 10 ثواني
            await page.wait_for_selector(".lot-detail", timeout=5000)  # 5 ثواني
...
async def scrape_iaa(lot: str):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.wait_for_selector(".lot-detail", timeout=5000)
